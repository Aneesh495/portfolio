...
const games = [
  {
    ...
    description: "Classic 3x3 grid game with AI",
    icon: Hash,
  ...
  },
  {
    ...
    description: "Addictive sliding puzzle",
    icon: Target,
  ...
  },
  {
    ...
    description: "Classic snake with multiple modes",
    icon: Move,
  ...
  },
  {
    ...
    description: "Naval warfare with smart AI",
    icon: Ship,
